    ...
    public function run(): void
    {
        ...
        $categories = [
            [
                ...
                'icon' => '<svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_826_6496)">
            ...
            [
                'name' => 'Computers',
                'icon' => '<svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_843_6422)">
            ...
            [
                'name' => 'SmartWatch',
                'icon' => '<svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_843_6275)">
            ...
            [
                'name' => 'Camera',
                'icon' => '<svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_843_1217)">
            ...
            [
                'name' => 'HeadPhones',
                'icon' => '<svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_843_1753)">
            ...
            [
                'name' => 'Gaming',
                'icon' => '<svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_843_4446)">
        ...
        $products = [
            [
                ...
                'image' => 'resources/assets/images/cards/card.png',
                'price' => '160',
                'discount' => '25',
                'category_id' => 6,
                'seller_id' => 11,
