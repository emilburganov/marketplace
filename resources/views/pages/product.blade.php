    ...
    <main>
        <div class="container">
            ...
            <section class="product catalog">
                <div class="product__container catalog__container">
                    <div class="product__card card">
                        ...
                        <div class="card__info">
                            ...
                            <div class="card__rating">
                                @auth
                                    <form action="{{ route('setRating', ['id' => $product->id]) }}" method="POST">
                                        @csrf
                                        <label class="cart__counter">
                                            <input
                                                ...
                                                type="number"
                                                name="rating"
                                                value="{{ $product->ratings()->where('user_id', Auth::id())->first()?->rating
                                                          ?? 5}}"
                                                min="0"
                                                max="5">
                                        </label>
